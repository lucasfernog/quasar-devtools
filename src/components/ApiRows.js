...
export default {
  ...
  methods: {
    getDiv (h, col, propName, propValue, slot) {
      return h('div', {
        staticClass: `api-row__item col-xs-12 col-sm-${col}`
      }, [
        h('div', [propName]),
        propValue !== void 0
          ? h('div', {
            staticClass: 'api-row__value'
          }, [propValue])
          : slot
      ])
    },
    ...
    events (h, {
      ...
      if ($listeners !== void 0) {
        child.push(
          h('div', {
            staticClass: 'api-row api-row__value api-row--big-padding'
          }, [
            $listeners.desc
          ])
        )
  ...
  render (h) {
    ...
    const content = Object.keys(api).length !== 0
      ? this[this.which](h, api) : [
        h('div', {
          staticClass: 'q-pa-md text-grey-7'
        }, [
